package com.github.xuqplus2.blog.aspect;
...
public class BindingResultProcessor {
     ...
     */
    @Pointcut("execution(public * com.github.xuqplus2.blog.controller..*Controller.*(..,org.springframework.validation.BindingResult,..))")
    public void pointB() {
    }
